...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-10">
                <div class="text-left">
                    <span style="font-size: 26.6667px;
                    font-family: sans-serif;
                    transform: scaleX(1.14611); color: #212121;"><b>Inspection & Maintenance Report</b></span>
                </div>
            </div>
        </div>
        <html-separator />
        <div class="row">
            <div class="col-xs-5" style="font-size: 16.6667px;
            font-family: sans-serif;
            transform: scaleX(1.07035);">
            ...
            <div class="col-xs-5" style="margin-left: 100px; font-size: 13.3333px;
            font-family: sans-serif;
            transform: scaleX(1.1617);">
    ...
    @forelse ($data['categories'] as $cate)
        <div class="container">
            <div class="row" style="background-color:#f5f5f5; padding-left: 0px; padding-top:5px; padding-bottom:5px;">
                <div class="col-xs-10">
                            ...
                            <div class="col-xs-5" style="margin-left: 100px;">
                                @forelse ($att->selected as $color)
                                    ...
                                    @elseif($color->value=='warning')
                                        <h5 class="text-center text-muted" style="background-color:yellow; color:black; padding:10px ; margin-top: 0; margin-bottom: 0px; margin-left: 50px;">{{$color->key ?? ''}}</h5>
                                    @endif
                                @empty
                                @endforelse
                            </div>
