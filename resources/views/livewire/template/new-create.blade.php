                ...
                <div class="col-6" wire:loading.remove wire:target="icon">
                    ...
                    @else
                        <div class="col-12 col-md-3 position-relative logo-alignment">
                            <img type="image"
                                 src="data:image/png|jpg|jpeg;base64, {!! base64_encode(file_get_contents(storage_path('app/images/' . $icon))) !!}"
                ...
                <div class="col-6" wire:loading.remove wire:target="optional_icon">
                    ...
                    @else
                        <div class="col-12 col-md-3 position-relative second-logo-alignment">
                            <img type="image"
                                 src="data:image/png|jpg|jpeg;base64, {!! base64_encode(file_get_contents(storage_path('app/images/' . $optional_icon))) !!}"
                                 alt="template icon" class="customfileupload" style="">
                            <a style="cursor: pointer; text-decoration: none;"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label class="mt-4 text-secondary">Title format (Pick up from key
                                            information
                    ...
                    <div class="gKLkhd">
                        <div class="cxbltl">
                            ...
                            <div style="padding: 0rem 1rem 0rem;">
                                ...
                                {{-- titlepage section --}}
                                <div
                                    class="kLpTzB wrapper" {{-- onclick="focusOnTitlePage()" {{ str_contains($this->activeone, 'p_') ? 'wire:ignore' : 'wire:ignore.self' }}  --}}>
                                                                ...
                                                                <div class="huXueT">
                                                                    <div class="kGgXUq">
                                                                        ...
                                                                        <div class="eWljvT" type="button" data-bs-toggle="collapse" data-bs-target="#section-collapse{{$loop->index}}" aria-expanded="true" aria-controls="section-collapse{{$loop->index}}">
                                                                            ...
                                                                            <svg viewBox="0 0 24 24" width="14"
                                                                                 height="14" id="hide{{$loop->index}}"
                                                                                 class="cBgwtB" style="display: block;"
                                                                                 focusable="false">
                                                                                <path
                                                                                    d="M12.819 17.633l8.866-9.52a1.323 1.323 0 0 0-.028-1.745 1.113 1.113 0 0 0-1.625-.03l-7.663 8.228a.509.509 0 0 1-.755 0L3.968 6.354a1.113 1.113 0 0 0-1.625.03 1.323 1.323 0 0 0-.028 1.745l8.85 9.504c.22.235.517.368.827.367a1.12 1.12 0 0 0 .827-.367z"
                                                                                    fill="white"
                                                                        ...
                                                                        <div class="haXfJL drag-icon" id="drag_icon{{$loop->index}}">
                                                                            <svg viewBox="0 0 24 24" width="24"
                                                                                ...
                                                                                <path
                                                                                    fill="{{ $activeone == $loop->index ? '#313235' : '#8c9097' }}"
                                                                                    d="M11 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 4c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z">
                                                                                </path>
                                                                            </svg>
                                                                        </div>
                                                                            ...
                                                                            @if ($title_page_questions[$activeone]['response'] == 7)
                                                                                @if (!empty($title_page_questions[$activeone]['multiple_choice']))
                                                                                    @forelse ($title_page_questions[$activeone]['multiple_choice'] as $responsKey => $respons)
                                                                                        <div
                                                                                            class="kLpTzB add_response_multible_choise_wrapper"
                                ...
                                <div class="kxBwiI">
                                    ...
                                    <div class="ijlOct cGmsts" wire:click.prevent="add_section()">
                                        Add section
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="gKLkhd">
                                <div class="cxbltl">
                                    <div style="padding: 0rem 1rem 0rem;">
                                        ...
                                        <div
                                            class="kLpTzB pagewrapper{{ $loop->index }}" {{-- onclick="focusOnPage()" {{ str_contains($this->activeone, 'p_') ? 'wire:ignore.self' : 'wire:ignore' }} --}}>
                                                            ...
                                                            <div class="bAJknk">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        @endif
                                                                        @if (count($this->pages[$loop->parent->index]['question']) > 1)
                                                                            <div class="epicTj">
                                                                                <div class="iBzfYz">
                                                                                    <li>
                                                                                        <a class="dropdown-item"
                                ...
                                <div wire:loading.remove wire:target="PageSetResponseValue">
                                                                                        ...
                                                                                        <div class="bBjJyf"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="color"
                                                                                                        id="P_add_response_color{{ $pageactiveone }}{{ $pagequestionactiveone }}{{ $responsKey }}"
                                    ...
                                    <div class="fhTZet" style="margin-left: 5px">
                                        <button role="button" class="kDSJkL"
                                                ...
                                                wire:click.prevent="page_save_multiple_choise" data-bs-dismiss="modal">
                                            Save
                                        </button>
                                                                                        ...
                                                                                        <div class="bBjJyf"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="color"
                                                                                                        id="P_edit_add_response_color{{ $pageactiveone }}{{ $pagequestionactiveone }}{{ $responsKey }}"
                                                                                                        wire:model="pages.{{ $pageactiveone }}.question.{{ $pagequestionactiveone }}.multiple_choice.{{ $responsKey }}.color"
                                                                                                        class="form-control form-control-color cTkvNJ d-none"
                                                                                                        title="Choose background color">
                                                                                                </div>
