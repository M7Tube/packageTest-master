        ...
        <div class="brCoKm">
            <div class="gBIxUd">
                                            ...
                                            <div class="QuestionInnerContainer">
                                                ...
                                                @elseif ($question['response'] == 6)
                                                    <div class="d-flex">
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="signatureModal{{ $loop->index }}"
                                                            tabindex="-1"
                                                    ...
                                                    <div class="etYWGL cBEPSE fehvTc">
                                                        <button color="#ffffff" font-size="0.875rem"
                                                            ...
                                                            <svg width="17" height="17" viewBox="0 0 16 16"
                                                                class="button_icon" focusable="false" fill="none">
                                                                <path
                                                    ...
                                                    <div class="gqIGVk">
                                                        <div class="kMPIlg">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="czOQuo">
                                                                    <button color="#ffffff" font-size="0.875rem"
                                                                        type="button" disabled="" class="cEDpxx">
                                                                        Save
                                                                    </button>
                            ...
                            @if (count($data['pages']) > 0 && request('page') < count($data['pages']) + 1)
                                <div class="eIqTdO">
                                    <button color="#ffffff" font-size="0.875rem" style="float: right;"
                                        type="button" onclick="focusOnTitlePage({{ request('page') ?? 0 }})"
                ...
                @forelse ($data['pages'] as $pKey => $page)
                    {{-- @if (request('page') == $loop->iteration) --}}
                    <div class="iAEKFw d-none">
                        <div class="jTJKJe">
                            <div class="blRQIx">
                                <div class="kYZfuZ">
                                    <div class="kSYIEK">
                                ...
                                @if (count($data['pages']) > 0 && request('page') < count($data['pages']) + 1)
                                    <div class="eIqTdO">
                                        <button color="#ffffff" font-size="0.875rem" style="float: right;"
                                            type="button" onclick="focusOnTitlePage({{ $loop->iteration }})"
                                            {{-- wire:click.prevent="next_page"  --}} class="gIOqQk">
                                            Next page
                ...
                <script>
                    function focusOnTitlePage(id) {
                        ...
                        pages.forEach(function callback(value, index) {
                            console.log(value.setAttribute('class', 'd-none'));
                            // console.log(id);
                            if (index == id + 1)
                                console.log(value.removeAttribute('class', 'd-none'));
                        });
                        // @this.set('page', id + 1);
